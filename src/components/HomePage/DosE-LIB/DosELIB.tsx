  ...
  return (
    <div className='dl'>
        <div className="title flex">
            <h1 className='flex'>DosE-LIB</h1>
        </div>
        <div className="flex">
            <img src={require('../img/lib.png')} alt="" />
        </div>
        <div className="download flex">
            <a href={require('../Products/Dose-LIB.apk')} download="DosE-LIB.apk" className="phone flex" >
            ...
            <a href={require('../Products/DosE-LIB Setup 1.0.0.exe')} download="DosE-LIB.exe" className="desk flex">
        ...
        <div className="tuto">
            ...
            <div className="phone flex">
                <img src={require('../img/lib/p(0).jpg')} alt="" />
                <img src={require('../img/lib/p (1).jpg')} alt="" />
                <img src={require('../img/lib/p (2).jpg')} alt="" />
                <img src={require('../img/lib/p (3).jpg')} alt="" />
            </div>
            <h1 className='flex'>Desktop</h1>
            <div className="win flex">
                <div className="two flex">
                    <img src={require('../img/lib/dt1.png')} alt="" />
                    <img src={require('../img/lib/dt2.png')} alt="" />
                </div>
                <div className="two flex">
                    <img src={require('../img/lib/dt3.png')} alt="" />
                    <img src={require('../img/lib/dt4.png')} alt="" />
                </div>
            </div>
        </div>
        <div className="details flex">
            <div className="crop flex">
                <h1>What is DosE-LIB ?</h1>
                <div className="hr"></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse saepe ipsam explicabo. Consectetur commodi ut nostrum fugiat nesciunt libero provident inventore veritatis sequi sit ab officia earum eligendi, saepe eveniet? Repellat quasi id accusantium saepe, optio quis minima ducimus unde sequi repellendus consequuntur adipisci corporis quas sapiente sint velit, tempore non, harum laboriosam? Optio soluta quibusdam obcaecati rem aliquam illum nobis consectetur, quae, recusandae laboriosam voluptatem expedita quo, totam repellat facere odio dolorum earum odit ratione suscipit. Eius facilis, iste magnam error iusto libero nihil alias dolores? Consequuntur ipsum error magnam eveniet, ducimus numquam itaque at labore tenetur doloremque sapiente!</p>
            </div>
        </div>
        <div className="details2 flex">
            <div className="crop flex">
                <h1>Why i make DosE-LIB ?</h1>
                <div className="hr"></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse saepe ipsam explicabo. Consectetur commodi ut nostrum fugiat nesciunt libero provident inventore veritatis sequi sit ab officia earum eligendi, saepe eveniet? Repellat quasi id accusantium saepe, optio quis minima ducimus unde sequi repellendus consequuntur adipisci corporis quas sapiente sint velit, tempore non, harum laboriosam? Optio soluta quibusdam obcaecati rem aliquam illum nobis consectetur, quae, recusandae laboriosam voluptatem expedita quo, totam repellat facere odio dolorum earum odit ratione suscipit. Eius facilis, iste magnam error iusto libero nihil alias dolores? Consequuntur ipsum error magnam eveniet, ducimus numquam itaque at labore tenetur doloremque sapiente!</p>
            </div>
        </div>
