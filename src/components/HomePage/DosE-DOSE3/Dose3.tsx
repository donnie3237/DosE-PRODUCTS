  ...
  return (
    <div className='dose3 flex'>
      ...
      <div className="contents contents2">
        ...
        <h1>Front-End</h1>
        <div className="flex">
          <img src={require('./solid.png')} alt="solid" />
          <img src={require('./React.png')} alt="react" />
        </div>
        </div>
        <div className="box">
          <h1>Back-End</h1>
           <img className='exp' src={require('./express.png')} alt="express" />
        </div>
        <div className="box">
          <h1>Mobile App</h1>
          <div className="flex">
            <img src={require('./tauri.png')} alt="tauri" />
          </div>
        </div>
        <div className="box">
        <h1>Desktop App</h1>
          <div className="flex">
            <img src={require('./tauri.png')} alt="tauri" />
            <img src={require('./electron.png')} alt="electron" />
          </div>
        </div>
      </div>
      <div className="req">
        ...
        <div className="contents contents2">
          <img className='box' src={require('./vscode.png')} alt="vscode" />
          ...
          <img className='box' src={require('./node.png')} alt="node" />
          <img className='box' src={require('./cargo.png')} alt="cargo" />
          <img className='box' src={require('./sdk.png')} alt="sdk" />
        </div>
      </div>
    </div>
  )
