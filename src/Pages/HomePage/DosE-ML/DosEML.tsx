  ...
  return (
    <div className='dl'>
        <div className="title flex">
            <h1 className='flex'>DosE-ML</h1>
        </div>
        <div className="flex">
            <img src={require('../img/ml.png')} alt="" />
        </div>
        <div className="download flex">
            <a href={require('../Products/DosE-ML.apk')} download='DosE-ML.apk' className="phone flex">
            ...
            <a href={require('../Products/DosE-ML Setup 1.0.0.exe')} download='DosE-ML.exe' className="desk flex">
        ...
        <div className="tuto">
            ...
            <div className="phone flex">
                <img src={require('../img/ml/p1 (1).jpg')} alt="" />
                <img src={require('../img/ml/p1 (2).jpg')} alt="" />
            </div>
            <h1 className='flex'>Desktop</h1>
            <div className="win flex">
                <div className="two flex">
                    <img src={require('../img/ml/dt1.png')} alt="" />
                    <img src={require('../img/ml/dt2.png')} alt="" />
                </div>
            </div>
        </div>
        <div className="details flex">
            <div className="crop flex">
                <h1>What is DosE-ML ?</h1>
