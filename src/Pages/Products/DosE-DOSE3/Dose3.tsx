  ...
  return (
    <div className='dose3 flex'>
      ...
      <div className="contents contents2">
        ...
        <h1>Front-End</h1>
        <div className="flex">
          <img src={require('./img/solid.png')} alt="solid" />
          <img src={require('./img/React.png')} alt="react" />
        </div>
        </div>
        <div className="box">
          <h1>Back-End</h1>
           <img className='exp' src={require('./img/express.png')} alt="express" />
        </div>
        <div className="box">
          <h1>Mobile App</h1>
          <div className="flex">
            <img src={require('./img/tauri.png')} alt="tauri" />
          </div>
        </div>
        <div className="box">
        <h1>Desktop App</h1>
          <div className="flex">
            <img src={require('./img/tauri.png')} alt="tauri" />
            <img src={require('./img/electron.png')} alt="electron" />
          </div>
        </div>
      </div>
      <div className="req">
        ...
        <div className="contents contents2">
          <img className='box' src={require('./img/vscode.png')} alt="vscode" />
          ...
          <img className='box' src={require('./img/node.png')} alt="node" />
          <img className='box' src={require('./img/cargo.png')} alt="cargo" />
          <img className='box' src={require('./img/sdk.png')} alt="sdk" />
        </div>
      </div>
    </div>
  )
