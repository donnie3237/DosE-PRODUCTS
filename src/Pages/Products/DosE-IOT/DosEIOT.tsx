  ...
  return (
    <div className='dl'>
        <div className="title flex">
            <h1 className='flex'>DosE-IOT</h1>
        </div>
        <div className="flex">
            <img src={require('../img/iot.png')} alt="" />
        </div>
        <div className="download flex">
            <a href={require('../Products/DosE-IOT.apk')} download='DosE-LIB.apk' className="phone flex">
            ...
            <a href={require('../Products/DosE-IOT Setup 1.0.0.exe')} download='DosE-IOT.exe' className="desk flex">
